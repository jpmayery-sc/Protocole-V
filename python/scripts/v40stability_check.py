...
from v40effective_core import evaluate_v40_stability, finalize_check
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the V40 stability check.")
