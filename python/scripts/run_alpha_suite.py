"""Run the alpha checks and summarize the result."""
...
def write_summary(summary: dict, result_dir: Path) -> tuple[Path, Path]:
    ...
    json_path = result_dir / f"alpha_suite_summary_{timestamp}.json"
    txt_path = result_dir / f"alpha_suite_summary_{timestamp}.txt"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the alpha checks and summarize them.")
