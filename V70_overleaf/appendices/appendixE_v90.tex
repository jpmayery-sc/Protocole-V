...
\subsection{Compatibilité avec la relativité générale}
Le protocole V90 doit être lu comme une reparamétrisation effective, pas comme un remplacement des tests validés de la relativité générale. Dans la limite de faible déformation, on impose la récupération du comportement standard:
\[
\alpha_g\to 0,\qquad \beta\to 0,\qquad w\to 0,
\]
ce qui entraîne
\[
g(z)\to 1,\qquad \tau(z)\to \tau_0,\qquad f_{\mathrm{photon}}(z)\to 1+z.
\]
Le protocole n'ajoute alors aucune correction locale aux équations d'Einstein: il ne fait que réécrire les observables de façon effective pour tester une lecture cinématique de la tension de Hubble et des régimes compacts.

La contrainte physique implicite est donc la suivante: en régime local et à faible courbure, les tests de système solaire, de pulsars binaires et de propagation des ondes gravitationnelles doivent rester inchangés à l'ordre de précision déjà validé. V90 n'a de sens que dans la mesure où ses paramètres de déformation s'éteignent dans ce régime.
