...
Le même modèle, avec et sans $\mathcal{L}_{ent}$, montre que l'ajout du couplage dérivatif réduit fortement $\chi^2$ et aligne $S_8$ sur la valeur observée. Le cas S8 / $f\sigma_8$ reste donc la démonstration calculée pilote, maintenant reliée à V92 pour le recalcul reproductible complet.
...
V94 franchit une étape nouvelle en s'appuyant sur le cadre consolidé V92/V93B pour réaliser un ajustement statistique complet par MCMC (Markov Chain Monte Carlo) du vecteur de paramètres cosmologiques $\{\alpha_K, \alpha_T, \alpha_{KT}, \gamma_*, \chi^2_{\text{couplage}}\}$ en utilisant les observables $H(z)$, $f\sigma_8(z)$ et $S_8$.
...
\clearpage
\appendix
\input{appendices/appendixA_equations.tex}
\input{appendices/appendixB_numerical_details.tex}
\input{appendices/appendixC_data_tables.tex}
\input{appendices/appendixD_methods.tex}
\input{appendices/appendixE_v90.tex}
\input{appendices/appendixF_v91.tex}
\input{appendices/appendixG_v92.tex}
\input{appendices/appendixH_v93b.tex}
\input{appendices/appendixI_v94.tex}
